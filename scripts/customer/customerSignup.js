...
updateButton.addEventListener('click', async (event) => {  // Make this async
  ...
  try {
    ...
    const docRef = await addDoc(usersCollection, newUserData);  // Await Firestore response
    console.log("Document written with ID: ", docRef.id);
    window.location.href = "./../../pages/signup/AuthenticatePage.html";
  } catch (error) {
