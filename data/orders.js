...
async function loadOrders() {
  try {
    ...
    // Parse `orderDate` strings as Date objects and sort in descending order
        ...
        <div class="order-details-grid">
          ...
          <div class="order-actions">
            ${order.orderConfirmation ? `
              <button class="track-package-button" onclick="goToTracking('${order.orderId}')">Track Order</button>
              <button class="receive-order-button" onclick="receiveOrder('${order.id}')">Receive Order</button>
            ` : `
